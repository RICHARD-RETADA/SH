...
}) =>
{
  ...
  {
    axios.get(`https://cakrayp.herokuapp.com/api/textmaker/textprome?text=${encodeURIComponent(test)}&theme=blackpink&apikey=cakrayp24Q6&responsetype=json`).then(res =>
    {
