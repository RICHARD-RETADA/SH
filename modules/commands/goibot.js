...
"bakit na naman?.",
"kanina kapa tawag ng tawag. may gusto", "saken?",
"di ako yan 🙄",
"wala akong piso!",
...
//REACTION HAHA
  ...
  if (event.body.indexOf("bot") == 0 || (event.body.indexOf("Bot") == 0) || (event.body.indexOf("BOT") == 0) || (event.body.toLowerCase().includes("pia"))) {
    var msg = {
      body: rand
    }
    return api.sendMessage(msg, threadID, messageID);
